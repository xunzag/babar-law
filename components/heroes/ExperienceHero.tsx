...
export default function ExperienceHero() {
  ...
  return (
    <HeroFrame crumb="Experience">
      <SplitWords
        text="Appointments since 2004."
      ...
      <div className="grid grid-cols-[auto_minmax(0,1fr)_auto] items-center gap-[clamp(14px,3vw,40px)]">
        <FadeIn delay={0.2}>
          <div className="font-medium text-[10.5px] tracking-[0.2em] uppercase text-cream/55 mb-2">Since</div>
        ...
        <FadeIn delay={2.2}>
          <div className="font-medium text-[10.5px] tracking-[0.2em] uppercase text-gold mb-2 text-right">Today</div>

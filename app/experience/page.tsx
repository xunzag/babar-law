          ...
          <div className="relative">
            ...
            {experience.map((x) => (
              <Reveal key={x.role + x.period + x.org}>
                <div className="group relative grid grid-cols-1 md:grid-cols-[200px_minmax(0,1fr)] gap-x-14 gap-y-2 pl-9 md:pl-0 py-8">
                  ...
                  <div className="md:text-right md:pt-1.5">
                    <div className="font-medium text-[12px] text-gold-deep mb-1.5">{x.period}</div>
                    <div className="text-ink/60 text-[13px] leading-snug">{x.place}</div>
                  </div>

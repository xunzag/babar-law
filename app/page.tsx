...
export default function HomePage() {
  const stats: [number, string, string?][] = [
    ...
    [partners.length, "International partners"],
  ];
    ...
    <div>
      ...
      <section className="bg-paper text-ink">
        <div className={`${wrap} pt-[clamp(80px,12vw,160px)] pb-[clamp(64px,9vw,120px)]`}>
          <div className="eyebrow text-gold-deep! mb-8 sm:mb-10">The firm</div>
          <ScrollText
          ...
          <Stagger className="mt-[clamp(64px,9vw,120px)] grid grid-cols-2 lg:grid-cols-4 border-t border-ink/15">
            {stats.map(([n, label, suffix], i) => (
              ...
              >
                ...
                <div className="font-medium text-[10.5px] tracking-[0.18em] uppercase text-ink/55">{label}</div>
              </StaggerItem>
            ))}
          </Stagger>
        </div>
      ...
      <section className="bg-paper-2 border-y border-ink/10 py-8">
        <div className={`${wrap} mb-5`}>
          <span className="font-medium text-ink/60 text-[10.5px] tracking-[0.22em] uppercase">
            Cooperation and panels
          </span>
        </div>
...
"Areas of practice."
            ...
            {areasHome.map((a) => (
              <StaggerItem key={a.num}>
                ...
                >
                  ...
                  <span className="relative font-medium text-[12px] text-gold group-hover:text-ink/60 transition-colors">
                    {a.num}
                  </span>
        ...
        <div className={`${wrap} py-[clamp(80px,11vw,150px)] grid grid-cols-1 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] gap-[clamp(40px,7vw,120px)] items-center`}>
          <div className="relative">
            ...
            <div className="absolute -bottom-5 right-3 lg:-right-8 bg-gold text-ink px-5 py-4 max-w-[220px]">
              <div className="font-medium text-[10px] tracking-[0.2em] uppercase opacity-70 mb-1">Principal</div>
          ...
          <div>
            <SectionHead
              label="The principal"
              title="Advocate of the High Court of Sindh, and counsel abroad."
              className="mb-9"
            />
            <Reveal delay={0.1}>
      ...
      <section className="bg-paper text-ink overflow-hidden">
        <div className={`${wrap} py-[clamp(80px,11vw,150px)]`}>
          <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_minmax(0,0.8fr)] gap-x-16 gap-y-10 items-end mb-[clamp(48px,6vw,80px)]">
            <SectionHead
              tone="light"
              label="Associates"
              className="mb-0"
title="The chambers."
            ...
            <Reveal delay={0.1} className="grid gap-6">
              ...
              <div>
                ...
                <div className="mt-3 flex flex-wrap gap-x-5 gap-y-1.5">
                  {teamGroups.map((g, i) => (
                    <span key={g.id} className="flex items-center gap-2 font-medium text-[10px] tracking-[0.14em] uppercase text-ink/55">
          ...
          <Reveal className="mt-12 flex flex-wrap items-center justify-between gap-6 border-t border-ink/15 pt-8">
            <span className="font-medium text-[11px] tracking-[0.16em] uppercase text-ink/62">
      ...
      <section className="relative bg-ink overflow-hidden">
        <div className={`relative ${wrap} py-[clamp(80px,11vw,150px)] grid grid-cols-1 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] gap-[clamp(40px,6vw,96px)] items-center`}>
          <div>
            <SectionHead
...
title="A record before the High Court of Sindh."
            ...
            <Stagger className="grid grid-cols-2 border-t border-cream/10 mb-10">
              {(
                ...
                >
                  ...
                  <div className="font-medium text-[10px] tracking-[0.18em] uppercase text-cream/60">{l}</div>
                </StaggerItem>
              ))}
            </Stagger>
            <Reveal delay={0.1}>
      ...
      <section className="bg-ink-3 border-y border-cream/8">
        <div className={`${wrap} py-[clamp(80px,11vw,150px)]`}>
          <SectionHead label="Distinctions" title="Panels and appointments." />
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
            ...
            {honors.map((h) => (
              <Reveal key={h.title} delay={0.1} className="h-full">
                <div className="relative h-full overflow-hidden flex flex-col justify-between gap-12 border border-gold/30 bg-ink-4 p-[clamp(24px,4vw,48px)]">
      ...
      {/* Global network */}
      <section className="bg-ink">
        <div className={`${wrap} py-[clamp(80px,11vw,150px)] grid grid-cols-1 lg:grid-cols-[minmax(0,0.8fr)_minmax(0,1.2fr)] gap-[clamp(40px,6vw,96px)]`}>
              ...
              const row = (
                <div className="flex items-center gap-6 py-5 group">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="font-medium text-cream/55 text-[10.5px] tracking-[0.12em] uppercase truncate mt-1.5">
                      {p.country}
                    </div>
                  </div>
                  {p.url && (
      ...
      <section className="bg-ink-2 border-t border-cream/8">
        <div className={`${wrap} py-[clamp(80px,11vw,150px)]`}>
          <SectionHead
            label="Recognition"
            title="Speaking and recognition."
            aside={
